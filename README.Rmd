...
## Willmann
indPars <- genInd(age=age, is.male=ismale, bw_targ=bw, ht_targ=ht, optimize = TRUE, method="Willmann")
...
## Willmann ; warning: this line would take a few minutes to run
popPars <- genPop(nSubj=nSubj, minAge=minAge, maxAge=maxAge, femPerc=femPerc, minBW=minBW, maxBW=maxBW, minHT=minHT, maxHT=maxHT, optimize = TRUE)
...
`PBPKToolkit` uses [pkgr](https://github.com/metrumresearchgroup/pkgr) to manage
