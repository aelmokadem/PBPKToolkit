...
This vignette shows the user how to use the main `mrgPBPK` package functions:

- `calcKp`: to calculate tissue:plasma partition coefficients for a molecule
- `genInd`: to generate individual physiological parameters
- `genPop`: to generate population physiological parameters
...
minBW <- 50
maxBW <- 100
minHT <- 1.5  #minimum height 1.5
maxHT <- 1.9  #maximum height 1.9
