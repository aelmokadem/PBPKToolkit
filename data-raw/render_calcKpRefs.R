test_cases <- list(
  ...
  list(
    logP = 2  #lipophilicity
    pKa = 1  #acidic strength
    type = NA  #type of molecule
    BP = 1  #blood:plasma concentration ratio
    fup = 0.5  #unbound fraction in plasma
    method ="pksim" #prediction method
  )
)
...
logP <- 2  #lipophilicity
pKa <- 1  #acidic strength
type <- seq(1,10)  #type of molecule
BP <- 1  #blood:plasma concentration ratio
fup <- 0.5  #unbound fraction in plasma
